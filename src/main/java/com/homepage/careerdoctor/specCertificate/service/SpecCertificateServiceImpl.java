...
public class SpecCertificateServiceImpl implements SpecCertificateService {
    ...
    // 스펙 진단하기
    @Override
    public ResponseEntity<CustomApiResponse<?>> sertificateSpec(SertificateSpecDto sertificateSpecDto) {

        Optional<SpecCertificate> foundSpec = specRepository.findByUserId(sertificateSpecDto.getUserId());
